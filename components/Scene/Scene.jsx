...
// Function to create connector materials with different properties
...
// Pointer component for mouse interaction
...
function Model({ children, color = 'white', roughness = 0, ...props }) {
  const ref = useRef()
  // For this component to work, you'll need the actual model file
...
const Scene3D = ({ width = "100%", height = "100%", style = {} }) => {
